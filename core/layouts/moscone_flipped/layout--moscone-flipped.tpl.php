 ...
 */
?>
<div class="layout--moscone-flipped <?php echo implode(' ', $classes); ?>"<?php echo backdrop_attributes($attributes); ?>>
  <div id="skip-link">
  ...
  <div class="l-wrapper">
    <div class="l-wrapper-inner container container-fluid">
      ...
      <div class="l-middle row">
        <main class="l-content col-md-9" role="main" aria-label="<?php echo t('Main content'); ?>">
