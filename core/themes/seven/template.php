...
function seven_tablesort_indicator($variables)
{
    ...
    if ($style == 'asc') {
        return theme('image', ['path' => $theme_path.'/images/caret-down--gray--32.png', 'alt' => t('sort ascending'), 'width' => 13, 'height' => 13, 'title' => t('sort ascending')]);
    } else {
        return theme('image', ['path' => $theme_path.'/images/caret-up--gray--32.png', 'alt' => t('sort descending'), 'width' => 13, 'height' => 13, 'title' => t('sort descending')]);
    }
}
